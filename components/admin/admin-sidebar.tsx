...
import { LayoutDashboard, Users, ClipboardCheck, Vote, ShieldCheck, ChevronRight, Languages, ClipboardList } from 'lucide-react'
...
const ADMIN_VIEWS: AdminView[] = ['dashboard', 'members', 'contributions', 'proposals', 'records', 'management']
