      ...
      <div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          <div className="rounded-2xl border border-[#F0F0F0] bg-[#FAFAFA] p-4">
            <div className="mb-3 flex h-9 w-9 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-600">
          ...
          <div className="rounded-2xl border border-[#F0F0F0] bg-[#FAFAFA] p-4">
            <div className="mb-3 flex h-9 w-9 items-center justify-center rounded-2xl bg-blue-50 text-blue-600">
        ...
        <p className="mt-5 rounded-2xl border border-[#F0F0F0] bg-[#FAFAFA] p-4 text-sm text-[#525252]">
