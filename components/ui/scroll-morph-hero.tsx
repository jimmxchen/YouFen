...
export default function IntroAnimation() {
    ...
    useEffect(() => {
        ...
        const handleWheel = (e: WheelEvent) => {
            ...
            // Only prevent default if we're within the virtual scroll range
            // Allow scrolling past the container when at boundaries
            const isAtBottom = currentScroll >= MAX_SCROLL && e.deltaY > 0;
            const isAtTop = currentScroll <= 0 && e.deltaY < 0;
        ...
        const handleTouchMove = (e: TouchEvent) => {
            ...
            // Only prevent default if we're within the virtual scroll range
            const isAtBottom = currentScroll >= MAX_SCROLL && deltaY > 0;
