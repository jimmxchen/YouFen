...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'PublicRecordType') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'ChainActionKind') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'ChainActionStatus') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'SignatureRole') THEN
    CREATE TYPE "SignatureRole" AS ENUM ('approver', 'member');
  END IF;
END$$;

-- CreateTable
CREATE TABLE IF NOT EXISTS "PublicRecord" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "CommunityTokenPolicy" (
    "id" TEXT NOT NULL,
    "communityId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "TokenEpoch" (
    "id" TEXT NOT NULL,
    "communityId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "TokenMintEvent" (
    "id" TEXT NOT NULL,
    "communityId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "TokenReversalEvent" (
    "id" TEXT NOT NULL,
    "communityId" TEXT NOT NULL,
    "memberId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "CommunityTokenState" (
    "id" TEXT NOT NULL,
    "communityId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "MemberTokenBalance" (
    "id" TEXT NOT NULL,
    "communityId" TEXT NOT NULL,
    "memberId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "TokenAdvanceRequest" (
    "id" TEXT NOT NULL,
    "communityId" TEXT NOT NULL,
    "epochId" TEXT NOT NULL,
    "memberId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "TokenPolicyVersion" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "ProposalMemberSnapshot" (
    "id" TEXT NOT NULL,
    "proposalId" TEXT NOT NULL,
    "memberId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "MemberSigner" (
    "id" TEXT NOT NULL,
    "communityId" TEXT NOT NULL,
    "memberId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "SignerChallenge" (
    "id" TEXT NOT NULL,
    "communityId" TEXT NOT NULL,
    "memberId" TEXT NOT NULL,
    "memberIdHash" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "CommunityController" (
    "id" TEXT NOT NULL,
    "communityId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "ChainAction" (
    "id" TEXT NOT NULL,
    "communityId" TEXT NOT NULL,
    "kind" "ChainActionKind" NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "TokenRuleVersion" (
    "id" TEXT NOT NULL,
    "communityId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "MemberEpochMintCounter" (
    "id" TEXT NOT NULL,
    "communityId" TEXT NOT NULL,
    "memberIdHash" TEXT NOT NULL,
    "epochNumber" INTEGER NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "MemberChainBalance" (
    "id" TEXT NOT NULL,
    "communityId" TEXT NOT NULL,
    "memberIdHash" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "ProposalExecution" (
    "id" TEXT NOT NULL,
    "communityId" TEXT NOT NULL,
    "proposalId" TEXT NOT NULL,
    "kind" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "PublicRecord_recordHash_key" ON "PublicRecord"("recordHash");
...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "CommunityTokenPolicy_communityId_key" ON "CommunityTokenPolicy"("communityId");

-- CreateIndex
CREATE INDEX "TokenEpoch_communityId_status_idx" ON "TokenEpoch"("communityId", "status");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "TokenEpoch_communityId_epochNumber_key" ON "TokenEpoch"("communityId", "epochNumber");

-- CreateIndex
CREATE INDEX "TokenMintEvent_advanceRequestId_idx" ON "TokenMintEvent"("advanceRequestId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "TokenMintEvent_contributionId_budgetSource_key" ON "TokenMintEvent"("contributionId", "budgetSource");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "TokenReversalEvent_originalMintEventId_key" ON "TokenReversalEvent"("originalMintEventId");

-- CreateIndex
CREATE INDEX "Proposal_communityId_status_idx" ON "Proposal"("communityId", "status");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "CommunityTokenState_communityId_key" ON "CommunityTokenState"("communityId");

-- CreateIndex
CREATE INDEX "MemberTokenBalance_communityId_idx" ON "MemberTokenBalance"("communityId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "MemberTokenBalance_communityId_memberId_key" ON "MemberTokenBalance"("communityId", "memberId");
...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "TokenPolicyVersion_policyId_version_key" ON "TokenPolicyVersion"("policyId", "version");

-- CreateIndex
CREATE INDEX "Vote_proposalId_idx" ON "Vote"("proposalId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Vote_proposalId_memberId_key" ON "Vote"("proposalId", "memberId");

-- CreateIndex
CREATE INDEX "ProposalMemberSnapshot_proposalId_idx" ON "ProposalMemberSnapshot"("proposalId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ProposalMemberSnapshot_proposalId_memberId_key" ON "ProposalMemberSnapshot"("proposalId", "memberId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "IdempotencyKey_endpoint_key_key" ON "IdempotencyKey"("endpoint", "key");

-- CreateIndex
CREATE INDEX "MemberSigner_communityId_memberId_idx" ON "MemberSigner"("communityId", "memberId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "MemberSigner_communityId_memberIdHash_key" ON "MemberSigner"("communityId", "memberIdHash");

-- CreateIndex
CREATE INDEX "SignerChallenge_communityId_memberIdHash_idx" ON "SignerChallenge"("communityId", "memberIdHash");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "CommunityController_communityId_key" ON "CommunityController"("communityId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "CommunityApprover_communityId_address_key" ON "CommunityApprover"("communityId", "address");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "SignatureRequest_digest_key" ON "SignatureRequest"("digest");

-- CreateIndex
CREATE INDEX "SignatureRequest_communityId_status_idx" ON "SignatureRequest"("communityId", "status");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Signature_signatureRequestId_signerAddress_key" ON "Signature"("signatureRequestId", "signerAddress");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ChainAction_recordHash_key" ON "ChainAction"("recordHash");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ChainAction_idempotencyKey_key" ON "ChainAction"("idempotencyKey");
...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ChainTransaction_txHash_key" ON "ChainTransaction"("txHash");
...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ChainEvent_txHash_logIndex_key" ON "ChainEvent"("txHash", "logIndex");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "SyncCheckpoint_communityId_key" ON "SyncCheckpoint"("communityId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "TokenRuleVersion_communityId_ruleVersion_key" ON "TokenRuleVersion"("communityId", "ruleVersion");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "MemberEpochMintCounter_communityId_memberIdHash_epochNumber_key" ON "MemberEpochMintCounter"("communityId", "memberIdHash", "epochNumber");

-- CreateIndex
CREATE INDEX "MemberChainBalance_communityId_idx" ON "MemberChainBalance"("communityId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "MemberChainBalance_communityId_memberIdHash_key" ON "MemberChainBalance"("communityId", "memberIdHash");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ProposalExecution_proposalId_key" ON "ProposalExecution"("proposalId");

-- AddForeignKey
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'Signature_signatureRequestId_fkey') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'ChainTransaction_chainActionId_fkey') THEN
