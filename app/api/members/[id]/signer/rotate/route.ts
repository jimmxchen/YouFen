// POST /api/members/:id/signer/rotate (§6 #3). Thin adapter: resolve Next async
...
import { handleSignerRotate } from '../../../../../../lib/api/signer/handlers';
...
export async function POST(
  ...
  const result = await handleSignerRotate(deps, { memberId: id, body, auth, idempotencyKey });
