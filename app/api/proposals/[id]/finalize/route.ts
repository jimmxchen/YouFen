// POST /api/proposals/:id/finalize — queue finalizeProposal(proposalId) (§6 #14).
...
import { handleFinalizeProposal } from '@/lib/api/gov-proposals/handlers';
...
export async function POST(
  ...
  const result = await handleFinalizeProposal(deps, { headers: req.headers, proposalId: id, body });
